...
<button
	class="w-full text-left cursor-pointer rounded-md flex h-full justify-items-center bg-gray-700 text-gray-300 fill-gray-400 py-3 px-4 drop-shadow ease-out duration-150 {addCSS} {activeCSS}"
	on:click={(e) => {
